...
def callback(data):
    ...
    joint.position = [data.theta1 * dtr, data.theta2 * dtr, data.theta3 * dtr, data.theta1 * dtr + a1_a, -a1_b, data.theta2 * dtr + a2_a, -a2_b, data.theta3 * dtr + a3_a, -a3_b, punto[0] / 1000, -punto[1] / 1000, punto[2] / 1000]
    joint.velocity = []
    joint.effort = []
